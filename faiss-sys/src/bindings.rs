...
#[doc = " Index based on a flat file\n"]
pub type FaissIndexBinaryFlat = FaissIndexBinary_H;
unsafe extern "C" {
    #[doc = " Index based on a flat file\n"]
...
unsafe extern "C" {
    #[doc = " Configure the batch size for queries."]
    pub fn faiss_IndexBinaryFlat_query_batch_size(
        arg1: *const FaissIndexBinaryFlat,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Configure the batch size for queries."]
    pub fn faiss_IndexBinaryFlat_set_query_batch_size(
        arg1: *mut FaissIndexBinaryFlat,
        arg2: ::std::os::raw::c_int,
    );
}
