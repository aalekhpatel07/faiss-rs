...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FaissRejectionResult_H {
    _unused: [u8; 0],
}
pub type FaissRejectionResult = FaissRejectionResult_H;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FaissIndexBinaryBloom_H {
    _unused: [u8; 0],
}
#[doc = " Opaque type for referencing to a binary index bloom object"]
pub type FaissIndexBinaryBloom = FaissIndexBinaryBloom_H;
unsafe extern "C" {
    #[doc = " Opaque type for referencing to a binary index bloom object"]
    pub fn faiss_IndexBinaryBloom_free(obj: *mut FaissIndexBinaryBloom);
}
unsafe extern "C" {
    #[doc = " Getter for d"]
    pub fn faiss_IndexBinaryBloom_d(arg1: *const FaissIndexBinaryBloom) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Create a new Binary Bloom index for vectors of the given dimension."]
    pub fn faiss_IndexBinaryBloom_new(
        p_index: *mut *mut FaissIndexBinaryBloom,
        d: idx_t,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Add n vectors of dimension d to the index.\n\n This function slices the input vectors in chunks smaller than\n blocksize_add and calls add_core.\n @param index  opaque pointer to index object\n @param x      input matrix, size n * d"]
    pub fn faiss_IndexBinaryBloom_add(
        index: *mut FaissIndexBinaryBloom,
        n: idx_t,
        x: *const u8,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Determine if any of the query vectors can be rejected safely,\n guaranteeing it does not fall within a reasonably small neighborhood\n of any vector from the database.\n\n @param index       opaque pointer to index object\n @param x           input vectors to search, size n * d\n @param result      result list, where true indicates the corresponding query\n can be rejected safely."]
    pub fn faiss_IndexBinaryBloom_reject(
        index: *const FaissIndexBinaryBloom,
        n: idx_t,
        x: *const u8,
        result: *mut FaissRejectionResult,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " removes all elements from the cache.\n @param index       opaque pointer to index object"]
    pub fn faiss_IndexBinaryBloom_reset(index: *mut FaissIndexBinaryBloom)
        -> ::std::os::raw::c_int;
}
...
unsafe extern "C" {
    pub fn faiss_SearchParametersHNSW_check_relative_distance(
        arg1: *const FaissSearchParametersHNSW,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn faiss_SearchParametersHNSW_set_check_relative_distance(
        arg1: *mut FaissSearchParametersHNSW,
        arg2: ::std::os::raw::c_int,
    );
}
unsafe extern "C" {
    pub fn faiss_SearchParametersHNSW_bounded_queue(
        arg1: *const FaissSearchParametersHNSW,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn faiss_SearchParametersHNSW_set_bounded_queue(
        arg1: *mut FaissSearchParametersHNSW,
        arg2: ::std::os::raw::c_int,
    );
}
